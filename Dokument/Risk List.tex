...
\textbf{Lösning}: Iterera fram bättre och bättre grafiska användargränssnitt och gör användartester mellan varje iteration. Följ guider som beskriver hur man förbättrar grafiska gränssnitt.
\end{itemize}
