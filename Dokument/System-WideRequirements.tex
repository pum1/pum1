...
Projektgruppens fokus kommer ligga på användarbarhet. Applikationen ska vara lätt att installera, vi planerar att utnyttja någon av linux pakethanterare. För användarensskull så ska programmets grafiska gränssnitt följa operativsystemets grafiska gränssnitt. 
