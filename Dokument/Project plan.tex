...
Utifrån den grund som lades i elaboration i form av arkitektur, design och krav så konstrueras resten av produkten i construction-fasen. Den här fasen är tillräckligt stor för att delas upp i minst två mindre iterationer. % , något som övriga faser ej tillåter. - stämmer väl inte, krisa nämnde att även elaboration kan delas upp i två iterationer.
